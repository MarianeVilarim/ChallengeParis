...
class MemoriaTelaCheiaView: UIView {

    

    let backgroundView = UIImageView(image: UIImage(named: "background"))
    
    let imageMemoria = UIImageView()
...
//        relatoTexto.delegate = self
    ...
    func setupViewsHierarchy() {
        ...
        imageContainer.addSubview(imageMemoria)
...
//        compartilharRoleButtonContainer.addSubview(compartilharRoleButton)
    ...
    func setupViewsAttributes() {
        ...
        headerStackView.contentMode = .top
//        headerStackView.backgroundColor = .white
        ...
        imageMemoria.contentMode = .scaleAspectFill
        imageMemoria.image = UIImage(named: "onboardingBox4")
    ...
    func setupConstraints() {
        ...
        imageMemoria.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            imageMemoria.topAnchor.constraint(equalTo: imageContainer.topAnchor),
            imageMemoria.leadingAnchor.constraint(equalTo: imageContainer.leadingAnchor),
            imageMemoria.trailingAnchor.constraint(equalTo: imageContainer.trailingAnchor),
        ...
        NSLayoutConstraint.activate([headerStackView.heightAnchor.constraint(equalTo: imageMemoria.heightAnchor),
        ...
        NSLayoutConstraint.activate([secondStackContainer.topAnchor.constraint(equalTo: headerStackView.bottomAnchor, constant: -320),
...
@available(iOS 13, *)
struct MemoriaTelaCheiaView_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        Group {
            MemoriaTelaCheiaView().showPreview().previewDevice("iPhone SE (3rd generation)")
            MemoriaTelaCheiaView().showPreview().previewDevice("iPhone SE (3rd generation)").previewInterfaceOrientation(.landscapeLeft)
        }
   }
